...
public class Submit04_UpDownBetMain {

	public static void main(String[] args) {
		
		Submin04_Updown_Player player1 = new Submin04_Updown_Player("플레이어1", 1000);
		Submin04_Updown_Player player2 = new Submin04_Updown_Player("플레이어2", 1000);
		
		Scanner sc = new Scanner(System.in);
		
		System.out.println("=============== UP & DOWN ===============");
		System.out.println("기회는 총 5번이며 숫자는 1 ~ 50중 하나입니다.");
		System.out.println("매 판 베팅 금액을 걸고 정답자가 베팅 금액을 가져갑니다.");
		System.out.println("베팅 금액은 소지금을 넘기지 않게 작성해주세요");
		System.out.println("=========================================");
