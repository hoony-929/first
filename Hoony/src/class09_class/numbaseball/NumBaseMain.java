 ...
 *  
 */
public class NumBaseMain {

	public static void main(String[] args) {
		Scanner sc = new Scanner(System.in);
		
		ComNum cn = new ComNum();
		...
		System.out.println("기회는 10번이며 각각 다른 3자리 수를 입력하면 됩니다.(0 ~ 9)");
		System.out.println("같은 자리에 같은 숫자라면 Strike, 자리는 다르나 숫자가 같다면 Ball이 출력됩니다.");
		System.out.println("첫째 자리는 0이 올 수 없습니다.");
		System.out.println();
		
		while(strike != 3) {
			strike = 0; // 반복문 안에서 초기화
			ball = 0;
